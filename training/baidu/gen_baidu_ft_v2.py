...
EXPERIMENT v2: same as the original FT gen, but reads the v2 adapter and writes
to a SEPARATE bench_outputs folder (Baidu_OCR_FT_v2) so the existing v1 column
in benchmark_results.json and the Inspector is never clobbered.
"""
...
OUT = Path(r"D:\ocr2tex\output\bench_outputs\Baidu_OCR_FT_v2")
PROGRESS = Path(r"D:\ocr2tex\output\baidu_ft_v2_gen_progress.json")
DEFAULT_ADAPTER = Path(r"D:\ocr2tex\experiments\baidu_v2\out\baidu-ocr-math-v2")
